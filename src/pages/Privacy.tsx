            ...
            <CardContent className="p-8 space-y-8">
              <section>
                ...
                <p className="text-white/80">
                  Il Titolare del trattamento dei dati è Birrificio Lido S.r.l., 
                  con sede in Via della Birra Artigianale, 42 - 00100 Roma (RM), 
                  P.IVA: 12345678901, email: privacy@birrificiolido.it
                </p>
              </section>
              ...
              <section>
                <h2 className="text-2xl font-display text-golden mb-4">3. Finalità del Trattamento</h2>
                <p className="text-white/80 mb-4">
              ...
              <section>
                <h2 className="text-2xl font-display text-golden mb-4">4. Base Giuridica</h2>
                <p className="text-white/80">
              ...
              <section>
                <h2 className="text-2xl font-display text-golden mb-4">5. Condivisione dei Dati</h2>
                <p className="text-white/80 mb-4">
              ...
              <section>
                <h2 className="text-2xl font-display text-golden mb-4">6. Conservazione dei Dati</h2>
                <p className="text-white/80">
              ...
              <section>
                <h2 className="text-2xl font-display text-golden mb-4">7. I Tuoi Diritti</h2>
                <p className="text-white/80 mb-4">
              ...
              <section>
                <h2 className="text-2xl font-display text-golden mb-4">8. Sicurezza</h2>
                <p className="text-white/80">
              ...
              <section>
                <h2 className="text-2xl font-display text-golden mb-4">9. Minori</h2>
                <p className="text-white/80">
              ...
              <section>
                ...
                <p className="text-white/80">
                  ...
                  contattaci a: privacy@birrificiolido.it
                </p>
